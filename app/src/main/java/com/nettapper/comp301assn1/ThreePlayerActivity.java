/*
    Implements the controller and view for the three player buzzer game.
...
public class ThreePlayerActivity extends AppCompatActivity {
    ...
    protected void onStart(){
        ...
        Button one = (Button) findViewById(R.id.threePlayer_PlayerOne);
        Button two = (Button) findViewById(R.id.threePlayer_PlayerTwo);
        Button three = (Button) findViewById(R.id.threePlayer_PlayerThree);
